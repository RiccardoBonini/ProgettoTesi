...
#versione dove vengono sistemate le linee in base agli elementi vicini
...
doc = minidom.parse("Esempio7_prima.svg")  # parseString also exists
...
#         if distanceBetweenPoints(elements[i].x1, elements[i].y1, elements[i - 1].x2, elements[i -1].y2) >= 1:
...
dwg = svgwrite.Drawing('Esempio7_dopo.svg', profile='full')
